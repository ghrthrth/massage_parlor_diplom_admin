...
public class ImageAdapter extends BaseAdapter implements Filterable {
    ...
    public ImageAdapter(Context mContext, List<String> mIds, List<String> mServiceIds, List<String> mTitles, List<String> mnames, List<String> msurnames, List<String> mphones) {
        this.mIds = mIds;
